...
window.onload = function () {
  var slider = new ESlider("#slider-1", ["https://4.bp.blogspot.com/-jS9AKEwPeHQ/UxeSbPDXWjI/AAAAAAAApWM/-emBFoRWuwU/s0/Aston+Martin+Supercars_Ultra+HD.jpg", "https://4.bp.blogspot.com/-jS9AKEwPeHQ/UxeSbPDXWjI/AAAAAAAApWM/-emBFoRWuwU/s0/Aston+Martin+Supercars_Ultra+HD.jpg", "https://4.bp.blogspot.com/-jS9AKEwPeHQ/UxeSbPDXWjI/AAAAAAAApWM/-emBFoRWuwU/s0/Aston+Martin+Supercars_Ultra+HD.jpg"]);
};
/* 
    Name: ESlider v1.0
    Author: Evyatar Daud
...
var ESlider = function ESlider(slider, images) {
  ...
  this.setSlide = function (id) {
    ...
    if (_(slider + " .ESlider-active-slide") != null) _(slider + " .ESlider-active-slide").classList.remove("ESlider-active-slide");
    /* reset active bulk */

    if (_(slider + " .ESlider-active-bulk") != null) _(slider + " .ESlider-active-bulk").classList.remove("ESlider-active-bulk");
    /* show new slide */
  ...
  this.next = function () {
    if (this.currentSlide == this.images.length) this.currentSlide = 1;else this.currentSlide++;
  ...
  this.previous = function () {
    if (this.currentSlide == 1) this.currentSlide = this.images.length;else this.currentSlide--;
    this.setSlide(this.currentSlide);
  };
